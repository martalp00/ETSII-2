...
public class QueuesPerformance {
	...
	public enum Implementation { WithArray, Linked, TwoStackQueue }
	...
	public static double test(Implementation impl, int seed, int length) {
		...
		Queue<Integer> queue = impl==Implementation.WithArray ? new ArrayQueue<>()
								: impl == Implementation.Linked ? new LinkedQueue<>()
								: new TwoStackQueue<>();
	...
	public static void main(String[] args) {
		...
		double t3 = avgTime(Implementation.TwoStackQueue, tests);
		...
		System.out.printf("Average execution time for TwoStackQueue is %f seconds\n", t3);
