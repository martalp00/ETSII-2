package dataStructures.Feb2021.isomorphicTrees;
...
/*
        if(res==true)
        {
            if(t1.left != null)
            {
                res =  isomorphicRec(t1.left, t2.left);
            }
            if(t1.right != null)
            {
                res =  isomorphicRec(t1.right, t2.right);
            }
        }
        */
        return isomorphicRec(t1.right, t2.right) && isomorphicRec(t1.left, t2.left);
    }
