...
public class Problema {
	...
	//Para la generación de numeros se ha hecho de la siguiente forma:
	//1º obtener un numero entre 0 y (nFilas*nColumnas - 1)
	//2ª la posición n esta en la fila=(n/nColumnas) y la columna=(n%nColumnas)
