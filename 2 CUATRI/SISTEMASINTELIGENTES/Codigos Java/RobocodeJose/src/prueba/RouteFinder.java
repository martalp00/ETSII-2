...
public class RouteFinder {
	...
	public static void main(String[] args) {
		...
		double pixelFila = fila*tamCelda + tamCelda/2;
		double pixelCol = columna*tamCelda + tamCelda/2;
		
		
		robotSetups[indice]=new RobotSetup(pixelFila          ,        //AQUÃ� DEBE FIGURAR LA FILA EN PIXELS CORRESPONDIENTE A LA POSICIÃ“N INICIAL DEL ROBOT
				                           pixelCol          ,        //AQUÃ� DEBE FIGURAR LA COLUMNA EN PIXELS CORRESPONDIENTE A LA POSICIÃ“N INICIAL DEL ROBOT    
		...
		for (int f = 0; f < nFil; f++){
			for (int c = 0; c < nCol; c++){
				if (matriz[f][c] == 1) {//SI HAY OBSTÃ�CULO EN ESA POSICIÃ“N DE LA MALLA
					...
					pixelFila = f*tamCelda + tamCelda/2;
					pixelCol = c*tamCelda + tamCelda/2;
					
					
					robotSetups[indice]=  new RobotSetup(pixelFila  ,   //AQUÃ� DEBE FIGURAR LA FILA EN PIXELS CORRESPONDIENTE AL CENTRO DE LA CELDA DONDE HAY OBSTÃ�CULO
							                             pixelCol  ,   //AQUÃ� DEBE FIGURAR LA FILA EN PIXELS CORRESPONDIENTE AL CENTRO DE LA COLUMNA DONDE HAY OBSTÃ�CULO
							                             0.0);    //orientaciÃ³n
					indice++;
